...
public class CursoMapper {
    ...
    public CursoRespostaDTO paraRespostaDTO(Curso curso, List<String> nomesProfessores) {

        return new CursoRespostaDTO(curso.getId(), curso.getNome(), curso.getCodigo(),nomesProfessores);
